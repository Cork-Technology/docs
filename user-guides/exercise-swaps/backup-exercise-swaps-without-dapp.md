---
description: How to exercise Swap Tokens using an atomic EIP-5792 capable wallet
hidden: true
---

# Backup - Exercise Swaps (without dApp)

Swap [Reference assets](../../core-concepts/reference-asset.md) into [Collateral assets](../../core-concepts/collateral-asset.md) by exercising Cork [Swap Tokens](../../core-concepts/swap-token.md), without using our dApp.

This operation, called an "exercise":

* returns Cork Swap Token (i.e. reduces its circulating supply)
* deposits [Reference Asset](../../core-concepts/reference-asset.md) into the Cork Pool
* withdraw [Collateral Asset](../../core-concepts/collateral-asset.md) (as much as the Cork Swap Token returned, minus exercise fee)

## **How to Swap Assets via an Escrowed Exercise**
...
* Completed a due diligence audit of the `safeExercise` function on `Line 468` of the escrow manager contract (CorkAdapter) at its live deployment address via either:
  ...
  * **Github:** [Link](https://github.com/Cork-Technology/phoenix/blob/7edd177f2500b1e00ad178bdc2d1b2d6fa3da986/contracts/periphery/CorkAdapter.sol#L468-L487)
* The Cork Pool's market id (bytes32).
  * A balance of Cork [Swap Token](../../core-concepts/swap-token.md) (cST) and [Reference Asset](../../core-concepts/reference-asset.md) that pertains to this [Cork Pool](../../core-concepts/cork-pool.md).
...
Add the 1st transaction to allow the trust-minimized escrow manager contract (CorkAdapter) to spend your Reference Assets:
